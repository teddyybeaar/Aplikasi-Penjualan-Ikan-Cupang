...
<div class="card text-center">
  <div class="card-header">
    ...
    <li class="nav-item">
        <a class="nav-link" style="color:black" href="<?php echo base_url()?>user/refund"><i class="fa fa-rotate-left"></i> Pengajuan Pengembalian</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="color:black" href="<?php echo base_url()?>user/verif"><i class="fa fa-check-square-o"></i> Verifikasi Admin</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" style="color:black" href="<?php echo base_url()?>user/pembelian"><i class="fa fa-truck"></i> Dikirim</a>
      </li>
      <li class="nav-item">
  ...
  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php $i=1; foreach($beli->result() as  $a){?>
                                        ...
                                        <td><?php echo $a->resi;?></td>
                                        <td> 
                                        <a href="<?php echo base_url('user/sukses/'.$a->id_transaksi)?>" class="btn btn-primary btn-sm" title="Konfirmasi Pesanan">Pesanan Diterima</a><br>
