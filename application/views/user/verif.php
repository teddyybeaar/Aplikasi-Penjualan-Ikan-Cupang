...
<div class="card text-center">
  <div class="card-header">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" style="color:black" href="<?php echo base_url()?>user/verif"><i class="fa fa-check-square-o"></i> Verifikasi Admin</a>
      </li>
      <li class="nav-item">
